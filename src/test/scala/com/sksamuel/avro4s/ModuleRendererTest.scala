...
class ModuleRendererTest extends WordSpec with Matchers {
  ...
  "new ModuleRenderer()" should {
    ...
    "generate Option[Either] for union types of 3 types with null" in {
      val rendered = new ModuleRenderer()(RecordType("com.sammy", "MyClass", Seq(FieldDef("name", UnionType(NullType, PrimitiveType.Int, PrimitiveType.Boolean)))))


      rendered shouldBe "//auto generated code by avro4s\ncase class MyClass(\n  name: Option[Either[Int, Boolean]]\n)"
    }
    "generate coproducts for union types of 3+ non-null types" in {

      new ModuleRenderer()(RecordType("com.sammy", "MyClass", Seq(FieldDef("name", UnionType(PrimitiveType.String, PrimitiveType.Int, PrimitiveType.Boolean))))) shouldBe
    ...
    "generate Option[coproducts] for union types of 3+ non-null types with null" in {
      ...
      new ModuleRenderer()(RecordType("com.sammy", "MyClass", Seq(FieldDef("name", UnionType(NullType, PrimitiveType.String, PrimitiveType.Int, PrimitiveType.Boolean))))) shouldBe
        """//auto generated code by avro4s
          |case class MyClass(
